#!/usr/bin/env sh
set -eu
# net-68-edge.sh — red fija + SMB para EDGE 192.168.68.x
...
ip addr add 192.168.68.20/24 dev "$IFACE"
...
echo "[OK] Listo. NIC=$IFACE  IP=192.168.68.20/24  GW=192.168.68.1  SMB=//192.168.68.128/shared -> /mnt/shared"
