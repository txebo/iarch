#!/usr/bin/env sh
set -eu
# net-1-edge.sh — red fija + SMB para EDGE 192.168.1.x
...
ip addr add 192.168.1.20/24 dev "$IFACE"
...
echo "[OK] Listo. NIC=$IFACE  IP=192.168.1.20/24  GW=192.168.1.1  SMB=//192.168.1.67/shared -> /mnt/shared"
